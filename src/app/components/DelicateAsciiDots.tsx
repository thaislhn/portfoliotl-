...
const DelicateAsciiDots = ({
  ...
  const getClickWaveInfluence = (x: number, y: number, currentTime: number) => {
  ...
  const animate = useCallback(() => {
    ...
    const newGrid: Array<Array<{ char: string; opacity: number } | null>> = Array(gridSize)
      .fill(0)
